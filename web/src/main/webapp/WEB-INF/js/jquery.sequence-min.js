    ...
    function n(n, r, i, s) {
        ...
        function g() {
            ...
            if (o.settings.hashTags === !0) {
                ...
                if (o.currentHashTag === undefined || o.currentHashTag === "")o.nextFrameID = o.settings.startingFrameID; else {
            ...
            if (o.transitionsSupported)if (!o.settings.animateStartingFrameIn) {
            ...
            } else o.goTo(o.nextFrameID, 1, !0); else {
                ...
                o.frames.not(":eq(" + (o.nextFrameID - 1) + ")").css({display: "none", opacity: 0});
                o._resetAutoPlay(!0, o.settings.autoPlayDelay)
            }
        ...
        }, o.beforeNextFrameAnimatesIn = function () {
        }, o.afterNextFrameAnimatesIn = function () {
        }, o.beforeCurrentFrameAnimatesOut = function () {
        }, o.afterCurrentFrameAnimatesOut = function () {
    ...
    n.prototype = {
        startAutoPlay: function (e) {
            ...
            if (!i.active || i.settings.navigationSkip) {
                i.active = !0;
                i._resetAutoPlay();
                n === undefined ? i.direction = t > i.currentFrameID ? 1 : -1 : i.direction = n;
                i.currentFrame = i.canvas.children(".animate-in");
                i.nextFrame = i.frames.eq(t - 1);
                ...
                if (i.pagination !== undefined) {
                    ...
                    e(i.paginationLinks[t - 1]).addClass("current")
                }
                if (i.transitionsSupported) {
                    ...
                    switch (i.settings.fallback.theme) {
                        case"fade":
                            i.frames.css({position: "relative"});
                            i.beforeCurrentFrameAnimatesOut();
                            i.currentFrame = i.frames.eq(i.currentFrameID - 1);
                            i.currentFrame.animate({opacity: 0}, i.settings.fallback.speed, function () {
                                i.currentFrame.css({display: "none", "z-index": "1"});
            ...
            var r = this;
            t.css(r._prefixCSS(e, {"transition-duration": n, "transition-delay": n, "transition-timing-function": ""}))
            ...
            if (r === "out")var u = function () {
                ...
                o._setHashTag();
                o.active = !1;
                if (!o.isHardPaused && !o.isBeingHoveredOver)if (!o.delayUnpause)o.unpause(!1); else {
                    o.delayUnpause = !1;
                    o.unpause()
                }
            };
            ...
            window.ModernizrForSequence = function (e, t, n) {
                ...
                var l = "2.6.1", c = {}, h = t.documentElement, p = "modernizrForSequence", d = t.createElement(p), v = d.style, m, g = {}.toString, y = "Webkit Moz O ms", b = y.split(" "), w = y.toLowerCase().split(" "), E = {svg: "http://www.w3.org/2000/svg"}, S = {}, x = {}, T = {}, N = [], C = N.slice, k, L = {}.hasOwnProperty, A;
